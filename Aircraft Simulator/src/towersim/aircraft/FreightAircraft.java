...
public class FreightAircraft extends Aircraft {
    ...
    /**
     * Unloads the aircraft of all cargo freight it is currently carrying.
     * This action will be performed instantly. After calling unload(),
     * OccupancyLevel.calculateOccupancyLevel()
