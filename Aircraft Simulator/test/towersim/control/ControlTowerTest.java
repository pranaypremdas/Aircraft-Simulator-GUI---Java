...
public class ControlTowerTest {
    ...
    public void setup() {
        ...
        aircrafts.add(passengerAircraft3);
        aircrafts.add(passengerAircraftAway);
        aircrafts.add(passengerAircraftTakingOff);
        aircrafts.add(passengerAircraftLanding);
        aircrafts.add(passengerAircraftLoading);
        aircrafts.add(passengerAircraftLoadingSingleTick);
        aircrafts.add(freightAircraftLoadingMultipleTicks);

        TakeoffQueue takeoffQueue = new TakeoffQueue();
        takeoffQueue.addAircraft(passengerAircraftTakingOff);
        ...
        loadingAircraft.put(passengerAircraftLoadingSingleTick, 1);
        loadingAircraft.put(freightAircraftLoadingMultipleTicks, 3);

        this.tower = new ControlTower(3, aircrafts, landingQueue, takeoffQueue, loadingAircraft);
